    ...
    <div className="py-30">
      <div className="container mx-auto text-center ">
        ...
        <div className="py-10 grid md:grid-cols-2 lg:grid-cols-3 px-5 gap-10 lg:20 xl:gap-25">
          {/* starter */}
          <div className=" bg-gray-100 shadow-md text-left rounded-2xl flex-1 flex flex-col ">
            <div className=" pt-12 pb-8 px-8 flex-1 flex flex-col">
              ...
              <button className="w-full mt-auto btn btn-primary rounded-full gradient-bg">
                Get Started Free
              </button>
            </div>
          </div>
          ...
          {/* pro */}
          <div className=" gradient-bg text-white text-left rounded-2xl  relative flex-1 flex flex-col">
            <div
            ...
            <div className=" pt-12 pb-8 px-8 flex-1 flex flex-col">
              ...
              <button className="w-full mt-auto bg-white  font-semibold py-4 rounded-full btn border-none  shadow-none hover:bg-white/90 transition-colors">
